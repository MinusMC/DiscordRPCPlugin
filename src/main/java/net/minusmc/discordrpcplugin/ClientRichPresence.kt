...
class ClientRichPresence : MinecraftInstance() {
    ...
    fun setup() {
        try {
            ...
            ipcClient = IPCClient(1131467194056855703)
    ...
    fun update() {
        ...
        if (assets.containsKey("logo"))
            builder.setLargeImage("https://i.imgur.com/Wputa6T.png", "LiquidBounce- Client " + LiquidBounce.CLIENT_VERSION)

        val serverData = mc.currentServerData

        // Set display infos
        builder.setState("LiquidBounce- Client")
        ...
        // Check ipc client is connected and send rpc to user
